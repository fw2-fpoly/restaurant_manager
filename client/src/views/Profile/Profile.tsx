import { Link, Box, Button, Flex, Grid, Heading, Img, Input, Radio, RadioGroup, Stack, Text, GridItem, FormControl, FormLabel, FormErrorMessage } from "@chakra-ui/react";
                    ...
                    >
                        ...
                        <Flex direction={"column"} gap={4}>
                            ...
                            <Flex direction="row" gap={4} >
                                <FormControl flex={1} isInvalid={errors.firstname as any}>
                                ...
                                <FormControl flex={1} isInvalid={errors.lastname as any} >
                            ...
                            <FormControl flex={1} isInvalid={errors.email as any} >
                            ...
                            <FormControl flex={1} isInvalid={errors.address as any}>
                            ...
                            <Flex direction="row" gap={4} >
                                <FormControl flex={1} isInvalid={errors.phone as any} >
                                ...
                                <FormControl flex={1} isInvalid={errors.date as any} >
                            ...
                            <Flex direction="row" gap={4} >
                                <FormControl flex={1} isInvalid={errors.location as any} >
                                ...
                                <FormControl flex={1} isInvalid={errors.code as any} >
