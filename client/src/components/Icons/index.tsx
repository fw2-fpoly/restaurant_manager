...
export const IconChat = ({
  ...
  <Icon width={size} height={size} fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
...
export const KitchenIcon = ({
  ...
  <Icon
    ...
    xmlns="http://www.w3.org/2000/svg"
  >
    <path d="M12 20.4a6 6 0 0 1-6-6c0-2.347.828-5.143 2.09-7.344.629-1.095 1.335-1.99 2.045-2.596.718-.612 1.351-.86 1.865-.86.513 0 1.147.248 1.865.86.71.607 1.416 1.5 2.044 2.596C17.172 9.257 18 12.053 18 14.4a6 6 0 0 1-6 6Zm0 1.2a7.2 7.2 0 0 0 7.2-7.2c0-5.176-3.6-12-7.2-12s-7.2 6.824-7.2 12a7.2 7.2 0 0 0 7.2 7.2Z"></path>
  </Icon>
);
//table

export const TableTwoIcon = ({ size = 36, color = "currentColor" }) => (
  <Icon
    width={size}
    height={size}
    fill="currentColor"
    ...
    xmlns="http://www.w3.org/2000/svg"
  >
    <path d="M18.25 3.25a2.5 2.5 0 0 1 2.5 2.5v12.5a2.5 2.5 0 0 1-2.5 2.5H5.75a2.5 2.5 0 0 1-2.5-2.5V5.75a2.5 2.5 0 0 1 2.5-2.5h12.5ZM5.75 2A3.75 3.75 0 0 0 2 5.75v12.5A3.75 3.75 0 0 0 5.75 22h12.5A3.75 3.75 0 0 0 22 18.25V5.75A3.75 3.75 0 0 0 18.25 2H5.75Z"></path>
    <path d="M8.875 7a1.875 1.875 0 1 1-3.75 0 1.875 1.875 0 0 1 3.75 0Zm10 10a1.875 1.875 0 1 1-3.75 0 1.875 1.875 0 0 1 3.75 0Z"></path>
  </Icon>
);

export const TableForIcon = ({
  size = 36,
  color = "currentColor",
  ...props
}) => (
  ...
  >
    <path d="M18.25 3.25a2.5 2.5 0 0 1 2.5 2.5v12.5a2.5 2.5 0 0 1-2.5 2.5H5.75a2.5 2.5 0 0 1-2.5-2.5V5.75a2.5 2.5 0 0 1 2.5-2.5h12.5ZM5.75 2A3.75 3.75 0 0 0 2 5.75v12.5A3.75 3.75 0 0 0 5.75 22h12.5A3.75 3.75 0 0 0 22 18.25V5.75A3.75 3.75 0 0 0 18.25 2H5.75Z"></path>
    <path d="M8.875 7a1.875 1.875 0 1 1-3.75 0 1.875 1.875 0 0 1 3.75 0Zm10 0a1.875 1.875 0 1 1-3.75 0 1.875 1.875 0 0 1 3.75 0Zm0 10a1.875 1.875 0 1 1-3.75 0 1.875 1.875 0 0 1 3.75 0Zm-10 0a1.875 1.875 0 1 1-3.75 0 1.875 1.875 0 0 1 3.75 0Z"></path>
  </Icon>
);

export const TableSixIcon = ({
  size = 36,
  color = "currentColor",
  ...props
}) => (
  ...
  >
    <path d="M18.25 3.25a2.5 2.5 0 0 1 2.5 2.5v12.5a2.5 2.5 0 0 1-2.5 2.5H5.75a2.5 2.5 0 0 1-2.5-2.5V5.75a2.5 2.5 0 0 1 2.5-2.5h12.5ZM5.75 2A3.75 3.75 0 0 0 2 5.75v12.5A3.75 3.75 0 0 0 5.75 22h12.5A3.75 3.75 0 0 0 22 18.25V5.75A3.75 3.75 0 0 0 18.25 2H5.75Z"></path>
    <path d="M8.875 7a1.875 1.875 0 1 1-3.75 0 1.875 1.875 0 0 1 3.75 0Zm10 0a1.875 1.875 0 1 1-3.75 0 1.875 1.875 0 0 1 3.75 0Zm0 10a1.875 1.875 0 1 1-3.75 0 1.875 1.875 0 0 1 3.75 0Zm0-5a1.875 1.875 0 1 1-3.75 0 1.875 1.875 0 0 1 3.75 0Zm-10 5a1.875 1.875 0 1 1-3.75 0 1.875 1.875 0 0 1 3.75 0Zm0-5a1.875 1.875 0 1 1-3.75 0 1.875 1.875 0 0 1 3.75 0Z"></path>
  </Icon>
);
