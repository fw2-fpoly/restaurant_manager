...
export const IconChat = ({ size = 36, strokeWidth = 1.5, color = "currentColor", ...props }) => (
	...
	>
		...
		<path fill={color} stroke="none" d="M7.5 13.5a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3Z" />
		<path fill={color} stroke="none" d="M12 13.5a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3Z" />
		<path fill={color} stroke="none" d="M16.5 13.5a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3Z" />
	</Icon>
);
...
export const WalletIcon = ({ size = 36, strokeWidth = 1.5, color = "currentColor", ...props }) => (
	...
	>
		...
		<path fill={color} stroke="none" d="M17.25 15a1.5 1.5 0 1 1 0-3 1.5 1.5 0 0 1 0 3Z" />
	</Icon>
);
